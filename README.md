...
### [我的博客在这里 &rarr;](https://yljgo.github.io/blog/)
...
```
# Site settings
title: Paul Blog             # 你的博客网站标题
SEOTitle: Paul Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: paulpro     # 你的github账号
weibo_username: paulpro      # 你的微博账号，底部链接会自动更新的。
